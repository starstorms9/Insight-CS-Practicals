'''
All basics done, just working on AI agent
'''
import numpy as np
...
#%%
for i in range(12) : print('{} : {}'.format(i, game.spotToXY(i)))

#%%
boards = np.array( [ [[1., 0., 1.],   # 0
                     [0., 0., 0.],
                     [2., 0., 2.]], 
...
tb = boards[4]
game.showBoard(tb)
print('X  ', game.playerWinSpots(1, tb))
print('Y  ', game.playerLoseSpots(1, tb))
